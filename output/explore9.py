"""Refine further: push p lower, widen Wb range, push xb close to L."""
import numpy as np
import tidy3d as td
...
configs = {}
triples = [
    (5.75, 3.5, 0.30), (5.75, 3.5, 0.40),
    (5.75, 3.75, 0.40), (5.75, 3.75, 0.50),
    (5.75, 4.0, 0.40), (5.75, 4.0, 0.50), (5.75, 4.0, 0.60),
    (5.9, 3.5, 0.30), (5.9, 3.5, 0.40),
    (5.9, 3.75, 0.40), (5.9, 3.75, 0.50),
    (5.9, 4.0, 0.40), (5.9, 4.0, 0.50), (5.9, 4.0, 0.60),
    (5.95, 3.5, 0.50), (5.95, 3.75, 0.50),
    (5.95, 4.0, 0.50), (5.95, 4.0, 0.60),
    (5.85, 3.6, 0.45), (5.85, 3.8, 0.50),
]
...
results = batch.run(path_dir="output/sim_data/sweep9")
